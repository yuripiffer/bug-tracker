...
describe('Bug API', () => {
    ...
    describe('getBugs', () => {
        it('should fetch bugs successfully', async () => {
            ...
            expect(global.fetch).toHaveBeenCalledWith('http://localhost:8080/api/bugs')
    ...
    describe('updateBug', () => {
        ...
        it('should update a bug successfully', async () => {
            ...
            expect(global.fetch).toHaveBeenCalledWith('http://localhost:8080/api/bugs/1', {
                method: 'PUT',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify(mockBug)
            })
        ...
        it('should handle not found error when updating a bug', async () => {
            ...
            await expect(updateBug("999", mockBug)).rejects.toThrow('Failed to update bug')
        })
